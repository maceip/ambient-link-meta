package com.lowkey.facechat.debug
...
import com.lowkey.facechat.soda.SodaFixtureRunner
...
class DictateDebugReceiver : BroadcastReceiver() {
  ...
  companion object {
    const val ACTION_FIXTURE = "com.lowkey.facechat.DEBUG_SODA_FIXTURE"
    const val ACTION_YANK = "com.lowkey.facechat.DEBUG_HUD_YANK"
